...
CO2_AVERAGE_WINDOW_S = 15.0

# -----------------------------
# MFC command smoothing / stability
# -----------------------------
MAX_MFC_STEP_MLN_MIN = 4.0
...
FEEDFORWARD_SMOOTHING_ALPHA = 0.25
...
# -----------------------------
MFC_SUPPLY_AVERAGE_WINDOW_S = 200.0

# Time window for smoothing final A_canopy values.
A_SMOOTHING_WINDOW_S = 200.0
    ...
    try:
        ...
        while True:
            ...
            if now - last_control_time >= CONTROL_INTERVAL_S:
                ...
                # Final safety clamp.
                # This bypasses minimum ON/OFF time for safety and updates the OFF timestamp.
